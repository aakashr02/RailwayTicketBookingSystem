        ...
        <nav>
            ...
            <div>
                ...
                <ul id="navbar" className={state.clicked ? '#navbar active' : "#navbar"}>
                    ...
                    <li><Link className='nav-link' href="/bookingHistory" to='/bookingHistory'>Booking History</Link></li>
                    <li><Link className='nav-link' to="/about-us">About Us</Link></li>
                    <li><button className='btn-logout btn-login' onClick={handleLogout}>Logout</button></li>
                </ul>
            </div>
