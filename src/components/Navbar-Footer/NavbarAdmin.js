    ...
    return (
        <div>
            <nav>
                ...
                <div>
                    <p className='head'>IRTBS</p>
                    <ul id="navbar" className={state.clicked ? '#navbar active' : "#navbar"}>
                        <li><Link className='nav-link' href="/" to='/'>Home</Link></li>
                        <li><Link className='nav-link' href="/search" to='/search'>Search Trains</Link></li>
                        <li><Link className='nav-link' to="/add-station">Add Station</Link></li>
                        <li><Link className='nav-link' to="/train-management">Add Train</Link></li>
                        <li><Link className='nav-link' to="/schedule">Add Route</Link></li>
                        <li><Link className='nav-link' to="/about-us">About Us</Link></li>
                        <li><button className='btn btn-login' onClick={handleLogout}>Logout</button></li>
                    </ul>
                </div>
